...
public abstract class TutorialState {
    ...
    public TutorialState(Game currentGame, GameBoardGui currentGameBoard, String backgroundImagePath) {
    ...
    public void setTokens(int [][] coords){
        ...
        for(int i = 0; i < coords.length; i++){
            ...
            if(playerType == 0){
                Token whiteToken = new Token(TokenType.WHITE,
                ...
                Token blackToken = new Token(TokenType.BLACK,
