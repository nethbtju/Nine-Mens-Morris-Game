...
public class TokenBank extends TokenStack {
   ...
   */
  public TokenBank(TokenType tokenType, String tokenImagePath, String selectedTokenImagePath) {
    super(9);
    while (!this.isFull()) {
      Token token = new Token(tokenType, tokenImagePath, selectedTokenImagePath);
